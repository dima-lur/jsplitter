...
/**
 * Convert Point size to Pixel size (useful in {@link gdi.Font} and such)
...
/**
 * Helper function for {@link GdiGraphics#DrawString DrawString} and {@link GdiGraphics#MeasureString MeasureString}
 * @memberof module:Helpers
 * @param {number} h_align
 * @param {number} v_align
 * @param {number} trimming
 * @param {number} flags
 */
